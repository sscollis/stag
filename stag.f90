...
!
! Notes:    All pressure solvers work except Conjugate Gradients
!
!============================================================================
...
!     delta_p := if true, use delta p form of discrete equations
!     alfa    := SIP parameter
...
!.... write restart file and Plot3d file
        ...
        if ( mod(n,nout) .eq. 0 .or. istep .eq. nstep) then
          ...
          write(*,"(79('='))")
          write (*,10) filen(1:index(filen,' ')-2), n
...
!.... Input run parameters and form the grid
      ...
      namelist /in/ Re, nstep, cfl_max, dt_max, tol, ictype, method, &
                    ...
                    alfa, bottom_bc, top_bc, left_bc, right_bc
...
!.... read a restart file
      ...
      call addver(base, 'R'//char(0), iver, filen, lfile)
      write (*,10) filen(1:index(filen,' ')-2)
